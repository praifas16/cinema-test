...
<head>
    ...
    <style>
        body {
            background-image: url('https://resource.nationtv.tv/uploads/images/md/2021/10/G5k44IRqI2iCmZb4XlVR.jpg'); /* ภาพพื้นหลังหาเปลี่ยนได้ตามต้องการ */            
            backdrop-filter: blur(10px);
            background-size: cover;
            font-family: Arial, sans-serif;
            margin: 0; /* กำหนดให้ไม่มีการเพิ่ม margin ใน body */
            padding: 0; /* กำหนดให้ไม่มีการเพิ่ม padding ใน body */
            width: 100vw; /* ความกว้างของ body เท่ากับ viewport width */
            height: 100vh; /* ความสูงของ body เท่ากับ viewport height */
            overflow: auto; /* ให้เกิดการเลื่อนหน้าจอเมื่อเนื้อหาเกินขนาด viewport */
        }
        ...
        .download-btn {
            ...
            padding: 10px 20px;
            background-color: #990000; /* เปลี่ยนสีปุ่ม ทั้งสองปุ่ม */
            color: white;
            border-radius: 5px;
            cursor: pointer;
